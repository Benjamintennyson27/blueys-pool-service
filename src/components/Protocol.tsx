...
const protocols = [
  {
    ...
    desc: 'We start with a thorough inspection of your pool\'s water chemistry, filtration system, surface condition, and equipment to build a custom care plan.',
    Animation: () => (
  ...
  },
  {
    ...
    desc: 'We clean, vacuum, brush, and chemically balance your pool for crystal-clear water. Equipment repairs and installations handled on the spot.',
    Animation: () => (
      <svg className="w-full h-full text-aqua" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    id: '03',
    title: 'Ongoing Care',
    desc: 'Regular scheduled maintenance keeps your pool in perfect condition year-round, so you can enjoy swimming without the hassle.',
    Animation: () => (
      <svg className="w-full h-full text-aqua" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2">
...
export default function Protocol() {
  ...
  return (
    <section aria-label="Our 3-step pool care process" className="protocol-container relative bg-cream" ref={containerRef}>
      {protocols.map((protocol, i) => (
        ...
        >
          <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center">
            ...
            <div className="order-1 md:order-2 aspect-square max-w-md w-full mx-auto bg-navy rounded-[3rem] p-12 flex items-center justify-center shadow-2xl border border-aqua/10" aria-hidden="true">
              <protocol.Animation />
            </div>
