...
export default function Philosophy() {
  ...
  return (
    <section
      id="story"
      ref={container}
      aria-label="Our story — 20+ years of trusted pool care"
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto flex flex-col gap-12 md:gap-20">
        <div ref={text1Ref} className="text-xl md:text-3xl font-sans font-medium text-cream/60 max-w-2xl">
          For over two decades, we've been servicing pools across the Sutherland Shire, Southern Sydney, and the Eastern Suburbs.
        </div>

        <div ref={text2Ref} className="text-4xl md:text-6xl lg:text-7xl font-serif italic text-white leading-tight">
          Your local pool experts — <span className="text-aqua not-italic font-sans font-bold">right price, on time, guaranteed.</span>
        </div>
      </div>
    </section>
  );
