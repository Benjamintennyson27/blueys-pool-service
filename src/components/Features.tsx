...
const ShufflerCard = () => {
  const [cards, setCards] = useState([
    { id: 1, title: 'Weekly Care', desc: 'Full vacuum, brush, skim & chemical balance every 7 days.' },
    { id: 2, title: 'Fortnightly', desc: 'Reliable maintenance for pools with minimal debris.' },
    { id: 3, title: 'Monthly Service', desc: 'Deep clean, equipment check & chemical shock treatment.' },
  ]);
...
const TypewriterCard = () => {
  ...
  const fullText = "Running pool diagnostics...\npH Level: 7.2 [OPTIMAL]\nChlorine: 3.0 ppm [OPTIMAL]\nAlkalinity: 95 ppm [STABLE]\nPump Pressure: 12 PSI [NORMAL]\nFilter Status: CLEAN\n\nPool Status: Swim Ready ✓";
  ...
  return (
    <div className="h-64 w-full bg-navy rounded-[2rem] p-6 flex flex-col relative overflow-hidden shadow-lg border border-aqua/20">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-xs font-mono text-aqua uppercase tracking-widest">Pool Diagnostics</span>
      </div>
...
const SchedulerCard = () => {
  ...
  useGSAP(() => {
    ...
    tl.set(cursorRef.current, { x: 0, y: 150, opacity: 0 })
      ...
      .to(dayRef.current, { backgroundColor: '#00E5FF', color: '#0A1128', duration: 0.1 })
  ...
  return (
    <div ref={containerRef} className="relative h-64 w-full bg-white rounded-[2rem] p-6 flex flex-col shadow-lg border border-navy/5">
      <div className="text-xs font-mono text-aqua mb-4 uppercase tracking-widest">Book A Service</div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 md:mb-24 text-center max-w-2xl mx-auto">
          ...
          <p className="text-lg text-charcoal/70">
            From regular maintenance to complex pump repairs, renovations, and even new pool construction — Blueys Pool Service handles it all with 20+ years of expertise.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="feature-card flex flex-col gap-6">
            ...
            <p className="text-charcoal/70">Flexible weekly, fortnightly, or monthly service tailored to your pool's specific needs.</p>
            <ShufflerCard />
          </div>

          <div className="feature-card flex flex-col gap-6">
            <h3 className="text-2xl font-bold text-navy">Equipment & Repairs</h3>
            <p className="text-charcoal/70">Pump repairs, filter servicing, heating systems, plumbing — we keep your equipment running smoothly.</p>
            <TypewriterCard />
          </div>

          <div className="feature-card flex flex-col gap-6">
            <h3 className="text-2xl font-bold text-navy">Easy Booking</h3>
            <p className="text-charcoal/70">Simple scheduling for regular service, green pool recovery, or one-off repairs across the Shire.</p>
            <SchedulerCard />
          </div>
        </div>
      </div>
